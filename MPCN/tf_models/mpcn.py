...
def multi_pointer_coattention_networks(self,
    ...
    for i in range(self.args.num_heads):
        ...
        # a1, a2 - pointer vector as [0,0,1,..,0] - can select certain reviews 
        self.att1.append(a1)
        self.att2.append(a2)
        self.afm.append(afm)
        ...
        # select the review on the -dmax- document axis
        ...
        # now _o1 and _o2 are embedding for two selected reviews
        print("Lengths:")
        print(q1_len)
