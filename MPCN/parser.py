...
def build_parser():
    ...
    ps("--num_proj", dest="num_proj", type=int, metavar='<int>',
       default=1, help="Number of projection layers") # l in the paper?
    ...
    ps("--num_aspect", dest="num_aspect", type=int, metavar='<int>',
       default=5, help="Number of aspect factors")
    ps("--lambda1", dest="lambda1", type=float, metavar='<float>',
        default=10, help="weight for experience ranking loss.")
    ...
    ps('--gpu', dest='gpu', type=int, metavar='<int>',
       default=3, help="Specify which GPU to use (default=0)")
    ...
    ps("--num_neg", dest="num_neg", type=int, metavar='<int>',
       default=4, help="Number of negative samples for pairwise training")
    ...
    ps('--base_encoder', dest='base_encoder',
       default='NBOW', help='BaseEncoder for hierarchical models')
    ps('--base_dynamic',  type=int, metavar='<int>',
       default=0, help='Use dynamic sliding window of reviews for users')
    ...
    ps('--recency',type=int, metavar='<int>',
       default=0, help='Use most recent reviews or not?')
    return parser
